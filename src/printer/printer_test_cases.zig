...
pub const test_cases = [_]TestCase{
    ...
    .{ .title = "BigIntLiteral#2", .input = "10_000n", .output = "10000n;" },
    ...
    .{ .title = "JsxElement1", .input = "<a></a>", .output = "<a></a>;" },
    .{ .title = "JsxElement2", .input = "<this></this>", .output = "<this></this>;" },
    .{ .title = "JsxElement3", .input = "<a:b></a:b>", .output = "<a:b></a:b>;" },
    .{ .title = "JsxElement4", .input = "<a.b></a.b>", .output = "<a.b></a.b>;" },
    .{ .title = "JsxElement5", .input = "<a<b>></a>", .output = "<a<b>></a>;" },
    .{ .title = "JsxElement6", .input = "<a b></a>", .output = "<a b></a>;" },
    .{ .title = "JsxElement7", .input = "<a>b</a>", .output = "<a>b</a>;" },
    .{ .title = "JsxElement8", .input = "<a>{b}</a>", .output = "<a>{b}</a>;" },
    .{ .title = "JsxElement9", .input = "<a><b></b></a>", .output = "<a><b></b></a>;" },
    .{ .title = "JsxElement10", .input = "<a><b /></a>", .output = "<a><b /></a>;" },
    .{ .title = "JsxElement11", .input = "<a><></></a>", .output = "<a><></></a>;" },
    .{ .title = "JsxElement12", .input = "<a>\n    {/* missing */}\n    {\n        // foo\n    }\n</a>", .output = "<a>\n    {/* missing */}\n    {\n    // foo\n    }\n</a>;" },
    .{ .title = "JsxSelfClosingElement1", .input = "<a />", .output = "<a />;" },
    .{ .title = "JsxSelfClosingElement2", .input = "<this />", .output = "<this />;" },
    .{ .title = "JsxSelfClosingElement3", .input = "<a:b />", .output = "<a:b />;" },
    .{ .title = "JsxSelfClosingElement4", .input = "<a.b />", .output = "<a.b />;" },
    .{ .title = "JsxSelfClosingElement5", .input = "<a<b> />", .output = "<a<b> />;" },
    .{ .title = "JsxSelfClosingElement6", .input = "<a b/>", .output = "<a b/>;" },
    .{ .title = "JsxFragment1", .input = "<></>", .output = "<></>;" },
    .{ .title = "JsxFragment2", .input = "<>b</>", .output = "<>b</>;" },
    .{ .title = "JsxFragment3", .input = "<>{b}</>", .output = "<>{b}</>;" },
    .{ .title = "JsxFragment4", .input = "<><b></b></>", .output = "<><b></b></>;" },
    .{ .title = "JsxFragment5", .input = "<><b /></>", .output = "<><b /></>;" },
    .{ .title = "JsxFragment6", .input = "<><></></>", .output = "<><></></>;" },
    .{ .title = "JsxAttribute1", .input = "<a b/>", .output = "<a b/>;" },
    .{ .title = "JsxAttribute2", .input = "<a b:c/>", .output = "<a b:c/>;" },
    .{ .title = "JsxAttribute3", .input = "<a b=\"c\"/>", .output = "<a b=\"c\"/>;" },
    .{ .title = "JsxAttribute4", .input = "<a b='c'/>", .output = "<a b='c'/>;" },
    .{ .title = "JsxAttribute5", .input = "<a b={c}/>", .output = "<a b={c}/>;" },
    .{ .title = "JsxAttribute6", .input = "<a b=<c></c>/>", .output = "<a b=<c></c>/>;" },
    .{ .title = "JsxAttribute7", .input = "<a b=<c />/>", .output = "<a b=<c />/>;" },
    .{ .title = "JsxAttribute8", .input = "<a b=<></>/>", .output = "<a b=<></>/>;" },
    .{ .title = "JsxSpreadAttribute", .input = "<a {...b}/>", .output = "<a {...b}/>;" },
};
