...
pub fn main(init: std.process.Init) !void {
    ...
    if (!needs_cross_file_graph) {
        try tsc.execute.tsc_module.transpileFile(allocator, io, filepath, outpath, null, null, null);
        return;
    }
    ...
    try tsc.execute.tsc_module.transpileFile(allocator, io, filepath, outpath, null, &graph, 0);
}
